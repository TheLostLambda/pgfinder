...
* I've not done this work in isolation and would like to acknowledge and thank my collaborators and co-workers Stephan
  Mesnage, Ankur Patel, and Bob Turner as well as the University Library who funded Unleash Your Data and Software.
...
* I'll give a very brief intro to Peptidoglycans because I know very little about the underlying molecular biology that
  underpins this work, in my defence its been over 20 years since I studied molecular biology and undergraduate level.
...
* But currently the structural organisation and binding mechanism is poorly understood, an improving knowledge is
important because doing so would improve our understanding of these important areas.
...
* Thank you, the FAIR4RS principles are an extension of the FAIR principles for data that many of you will be familiar
  with but with the software should be Findable, Interoperable and Accessible but with a particular focus that address
...
* At the same time we have released the package the Python Package Index, a site for sharing and installing Python
  packages with the world and this helps lower the barrier for others to install and use the software.
...
* The code is accessible via GitHub and has been version controlled which provides a traceable record of the changes
  that have been made over time, in much the same manner as laboratory books record the steps taken in lab based
  experiments.
...
use once the work has been completed. Since the work started there have been 60 issues created of which 47 (78%) have
been closed. You close issues by making pull requests to incorporate changes you've made on your branch into the main
code and we've had 68 pull requests so far with only three outstanding (4%).
